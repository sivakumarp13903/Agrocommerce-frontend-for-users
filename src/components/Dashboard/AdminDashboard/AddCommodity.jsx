...
const AddCommodity = ({ url }) => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        try {
            const response = await axios.post(`http://localhost:5000/api/commodity/add`, formData);
    ...
    return (
        <div className="add">
            ...
            <form enctype="multipart/form-data" className='flex-col' onSubmit={onSubmitHandler}>
                {/* Image Upload */}
                ...
                <div className="add-product-description flex-col">
                    ...
                    <textarea onChange={onChangeHandler} value={data.description} name="description" rows="6" placeholder="Describe the product (e.g., quality, usage, benefits)" required></textarea>
                </div>
